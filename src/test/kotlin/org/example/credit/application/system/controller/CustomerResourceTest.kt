...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("Campos"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("15787445716"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("juancampos.bsi@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua da Caminho foz jordao, 123"))
    ...
    fun `should not find customer with invalid id and return 400 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(
                MockMvcResultMatchers.jsonPath("$.exception")
                    .value("class org.example.credit.application.system.exception.BusinessException")
            )
            .andExpect(MockMvcResultMatchers.jsonPath("$.details[*]").isNotEmpty)
            .andDo(MockMvcResultHandlers.print())
    }
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("JuanUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("CamposUpdate"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("15787445716"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("juancampos.bsi@email.com"))
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "JuanUpdate",
        lastName: String = "CamposUpdate",
